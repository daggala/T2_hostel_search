...
public class StayLength {
	...
	public StayLength(int arrYear, int arrMonth, int arrDate, int depYear,
			int depMonth, int depDate) {
	...
	public int getDaysBetweenDates() {
		...
		start = new DateTime(this.arrivalYear, this.arrivalMonth,
				this.arrivalDate, 0, 0, 0, 0);
		end = new DateTime(this.departureYear, this.departureMonth,
				this.departureDate, 0, 0, 0, 0);
